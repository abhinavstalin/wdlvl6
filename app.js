...
app.get("/todos", async function (_request, response) {
  console.log("list of Todos are being Fetched ...");
...
app.post("/todos", async function (request, response) {
  console.log("creating new todo and redirecting to main page", request.body);
  try {
...
//app.put using id todos/:id
app.put("/todos/:id", async function (request, response) {
  console.log("Mark Todo as completed based on id:", request.params.id);
  const todo = await Todo.findByPk(request.params.id);
